...
<section class="top xyz" id="parallax">
    <nav class="navbar navbar-expand-lg sticky-top navbar-dark bg-*"
        ...
        <a class="navbar-brand" href="index.jsp" style="font-family: 'Aileron', sans-serif; font-weight: 500;">Chandana
            Hotel & Lodging</a>
    ...
    <div class="hero container-fluid" style="width: 100%">
        <center>
            ...
            <div class="container">
                <span class="offer" style="background-color: #FFF9A6; padding: 2vh 2vw; border-radius: 10px; color:  #A96E00FF;">&bull;&nbsp;<strong>15% off on our Deluxe room for a limited period of time&nbsp;&bull;</strong></span>
            </div>
            </p>
...
<section class="container-fluid xyz" id="about" style="width: 100%">
    <div class="hid">
        <center><h1 data-aos="fade-out" style="font-family: 'Aileron', sans-serif;">About Us</h1></center>
        <br>
    </div>
    <div class="abt-us">
        ...
        <div class="abt-us-text">
            ...
            <p data-aos="fade-up" style="font-family: 'Merriweather', serif;">Situated in Cooch Behar, Chandana Hotel
                and Lodging is located in one of the cities most popular
...
<section class="customer-reviews xyz" id="reviews">
    <div class="container-fluid" style="background-color: white;">
        <center><h1 data-aos="fade-out" class="cr-heading" style="font-family: 'Aileron', sans-serif;font-weight: 100;">
            Customer Reviews</h1></center>
        <br>
            ...
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body" style="display: flex; align-items: center;justify-content: center;">
                    <p class="card-text" style="font-family: 'Merriweather', serif;">The food and the services they
                        provide is more valuable than the price they take, hygienic food and probably the best food and
                        lodging service in Cooch Behar</p>
                </div>
            </div>
            <div class="card" style="width: 18rem;">
                <div class="cr-img">
                ...
                <div class="card-body" style="display: flex; align-items: center;justify-content: center;">
                    <p class="card-text" style="font-family: 'Merriweather', serif;">I usually visit this hotel for
                        Lunch,their food is the best in town,they are known for good service quality & authentic food.
                        The place does not offer parking but a paid parking area is near. They have rooms also and they
                        are good too.</p>
                </div>
            </div>
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body" style="display: flex; align-items: center;justify-content: center;">
                    <p class="card-text" style="font-family: 'Merriweather', serif;">The food is really very good,
                        ...
                        Lunch,their food is the best in town,they are known for good service quality & authentic food.
                        The hotel a crowded in lunch time so have some patience.
                    </p>
                </div>
            </div>
        </div>
...
<section class="contact-us-bg xyz" id="contactus">
    <div class="container">
        <div class="contact">
            <br>
            <center><h1 data-aos="fade-up" style="font-family: 'Aileron', sans-serif;font-weight: 100;">Contact Us</h1>
                <br>
                ...
                <div class="contact-form">
                    <form id="feedback-form" data-aos="zoom-out">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="QueryType" id="Review"
                                       value="review">
                        ...
                        <center>
                            <button type="button" class="btn btn-info" id="submit_feedback">Submit</button>
                        </center>
                    </form>
                </div>
            </div>
...
<div class="bg-dark">
    <hr>
    <center><strong style="color: lightgrey; font-family: 'Merriweather', serif;">&copy; - 2022 -
        ChandanaHotelAndLodging - Privacy</strong></center>
    <hr>
</div>
